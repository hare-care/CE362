...
// Generated on: Feb  5 2024 23:40:49 CST (Feb  6 2024 05:40:49 UTC)
...
module exec_top(ALU_Control, branch_op, clk, rstn, operand_A,
  ...
  DFFR_X1 \jump_target_PC_reg[0] (.RN (rstn), .CK (clk), .D (n_12), .Q
       (jump_target_PC[0]), .QN (UNCONNECTED96));
  DFFR_X1 \jump_target_PC_reg[1] (.RN (rstn), .CK (clk), .D (n_11), .Q
       (jump_target_PC[1]), .QN (UNCONNECTED97));
  DFFR_X1 \jump_target_PC_reg[2] (.RN (rstn), .CK (clk), .D (n_9), .Q
       (jump_target_PC[2]), .QN (UNCONNECTED98));
  DFFR_X1 \jump_target_PC_reg[3] (.RN (rstn), .CK (clk), .D (n_10), .Q
       (jump_target_PC[3]), .QN (UNCONNECTED99));
  DFFR_X1 \jump_target_PC_reg[4] (.RN (rstn), .CK (clk), .D (n_8), .Q
       (jump_target_PC[4]), .QN (UNCONNECTED100));
  DFFR_X1 \jump_target_PC_reg[5] (.RN (rstn), .CK (clk), .D (n_7), .Q
       (jump_target_PC[5]), .QN (UNCONNECTED101));
  DFFR_X1 \jump_target_PC_reg[6] (.RN (rstn), .CK (clk), .D (n_6), .Q
       (jump_target_PC[6]), .QN (UNCONNECTED102));
  DFFR_X1 \jump_target_PC_reg[7] (.RN (rstn), .CK (clk), .D (n_5), .Q
       (jump_target_PC[7]), .QN (UNCONNECTED103));
  DFFR_X1 \jump_target_PC_reg[8] (.RN (rstn), .CK (clk), .D (n_4), .Q
       (jump_target_PC[8]), .QN (UNCONNECTED104));
  DFFR_X1 \jump_target_PC_reg[9] (.RN (rstn), .CK (clk), .D (n_3), .Q
       (jump_target_PC[9]), .QN (UNCONNECTED105));
  DFFR_X1 \jump_target_PC_reg[10] (.RN (rstn), .CK (clk), .D (n_2), .Q
       (jump_target_PC[10]), .QN (UNCONNECTED106));
  DFFR_X1 \jump_target_PC_reg[11] (.RN (rstn), .CK (clk), .D (n_1), .Q
       (jump_target_PC[11]), .QN (UNCONNECTED107));
  DFFR_X1 \jump_target_PC_reg[12] (.RN (rstn), .CK (clk), .D (n_15), .Q
       (jump_target_PC[12]), .QN (UNCONNECTED108));
  DFFR_X1 \jump_target_PC_reg[13] (.RN (rstn), .CK (clk), .D (n_28), .Q
       (jump_target_PC[13]), .QN (UNCONNECTED109));
  DFFR_X1 \jump_target_PC_reg[14] (.RN (rstn), .CK (clk), .D (n_16), .Q
       (jump_target_PC[14]), .QN (UNCONNECTED110));
  DFFR_X1 \jump_target_PC_reg[15] (.RN (rstn), .CK (clk), .D (n_30), .Q
       (jump_target_PC[15]), .QN (UNCONNECTED111));
  DFFR_X1 \jump_target_PC_reg[16] (.RN (rstn), .CK (clk), .D (n_29), .Q
       (jump_target_PC[16]), .QN (UNCONNECTED112));
  DFFR_X1 \jump_target_PC_reg[17] (.RN (rstn), .CK (clk), .D (n_27), .Q
       (jump_target_PC[17]), .QN (UNCONNECTED113));
  DFFR_X1 \jump_target_PC_reg[18] (.RN (rstn), .CK (clk), .D (n_26), .Q
       (jump_target_PC[18]), .QN (UNCONNECTED114));
  DFFR_X1 \jump_target_PC_reg[19] (.RN (rstn), .CK (clk), .D (n_25), .Q
       (jump_target_PC[19]), .QN (UNCONNECTED115));
  DFFR_X1 \jump_target_PC_reg[20] (.RN (rstn), .CK (clk), .D (n_24), .Q
       (jump_target_PC[20]), .QN (UNCONNECTED116));
  DFFR_X1 \jump_target_PC_reg[21] (.RN (rstn), .CK (clk), .D (n_23), .Q
       (jump_target_PC[21]), .QN (UNCONNECTED117));
  DFFR_X1 \jump_target_PC_reg[22] (.RN (rstn), .CK (clk), .D (n_22), .Q
       (jump_target_PC[22]), .QN (UNCONNECTED118));
  DFFR_X1 \jump_target_PC_reg[23] (.RN (rstn), .CK (clk), .D (n_21), .Q
       (jump_target_PC[23]), .QN (UNCONNECTED119));
  DFFR_X1 \jump_target_PC_reg[24] (.RN (rstn), .CK (clk), .D (n_20), .Q
       (jump_target_PC[24]), .QN (UNCONNECTED120));
  DFFR_X1 \jump_target_PC_reg[25] (.RN (rstn), .CK (clk), .D (n_19), .Q
       (jump_target_PC[25]), .QN (UNCONNECTED121));
  DFFR_X1 \jump_target_PC_reg[26] (.RN (rstn), .CK (clk), .D (n_18), .Q
       (jump_target_PC[26]), .QN (UNCONNECTED122));
  DFFR_X1 \jump_target_PC_reg[27] (.RN (rstn), .CK (clk), .D (n_17), .Q
       (jump_target_PC[27]), .QN (UNCONNECTED123));
  DFFR_X1 \jump_target_PC_reg[28] (.RN (rstn), .CK (clk), .D (n_31), .Q
       (jump_target_PC[28]), .QN (UNCONNECTED124));
  DFFR_X1 \jump_target_PC_reg[29] (.RN (rstn), .CK (clk), .D (n_14), .Q
       (jump_target_PC[29]), .QN (UNCONNECTED125));
  DFFR_X1 \jump_target_PC_reg[30] (.RN (rstn), .CK (clk), .D (n_0), .Q
       (jump_target_PC[30]), .QN (UNCONNECTED126));
  DFFR_X1 \jump_target_PC_reg[31] (.RN (rstn), .CK (clk), .D (n_13), .Q
       (jump_target_PC[31]), .QN (UNCONNECTED127));
